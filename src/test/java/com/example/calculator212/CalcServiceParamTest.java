...
import static com.example.calculator212.ResultGenerator.*;
...
public class CalcServiceParamTest {
    ...
    void plus_success(int num1, int num2, String expectedResult) {
        Assertions.assertEquals(calculatorService.sum(num1, num2), expectedResult);
    }

    @ParameterizedTest
    @MethodSource("minusParams")
    void minus_success(int num1, int num2, String expectedResult) {
        Assertions.assertEquals(calculatorService.minus(num1, num2), expectedResult);
    }

    @ParameterizedTest
    @MethodSource("multiplyParams")
    void multiply_success(int num1, int num2, String expectedResult) {
        Assertions.assertEquals(calculatorService.multiply(num1, num2), expectedResult);
    }

    @ParameterizedTest
    @MethodSource("divideParams")
    void divide_success(int num1, int num2, String expectedResult) {
